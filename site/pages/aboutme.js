    ...
    <>
      ...
      <div>
        ...
        <p>
          ...
          draw some similarity in pushing the limits of the body in running a
          70km ultramarathon as a regular guy who has never done a full 42km
          run.
        </p>
        <p>
          A geneticist by training, that mostly tinkered in the lab, wondered
          into the world of agricultural R&D, performed data analysis from field
          trials, consulting stakeholders on the interaction of plants, climate,
          terrain, pests and diseases throughout the lifecycle of a plant.
          Studied the origin and importance of inanimate rocks, sand, silt and
          clay - the very thing allowed entire civilizations to be fed and built
          upon.
        </p>
        <p>
          ...
          progress of a perrenial crop that is usually measured in years
          naturally slowed personal progress. Perhaps I should have taken cue
          and made my move earlier when I was the defacto "IT" guy at work
          troubleshooting printer and hardware issues. Better late than never.
          I'm grateful and appreciate the opportunities it provided, but it was
          time to move on.
        </p>
        <p>
