...
export default function AboutMe() {
  return (
    <div>
      ...
      <p>
        My new journey is fairly recent starting in early 2022, but I did have
        an early start in hacking psp consoles using guides on sketchy sites in
        my youth and installing OS that I had no use for. I also should taken
        cue and made my move earlier when I was the defacto "IT" guy at work
        troubleshooting printer and hardware issues.
      </p>
      ...
      ></script> */}
      <p>
        Familiar with Javascript, Node.js/Express, React, React Native, SQL,
        MongoDB. Exploring Python. This will be updated accordingly.
      </p>
    </div>
  );
}
